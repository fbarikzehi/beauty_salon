...
<td class="border-0" style="{{monthTdStyle}}" {{monthTdAttribute}} data-td-month>
    ...
    var previousYearTextPersian = 'سال قبل',
        ...
        minuteText = 'Minute',
        secondText = 'Second',
        previousYearIcon = '<i class="flaticon2-fast-next"></i>',
        previousMonthIcon = '<i class="flaticon2-next"></i>',
        nextMonthIcon = '<i class="flaticon2-back"></i>',
        nextYearIcon = '<i class="flaticon2-fast-back"></i>',
        amPm = {
            am: 0,
            pm: 1,
            none: 2
